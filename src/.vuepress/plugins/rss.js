  ...
  return {
    ...
    generated() {
      ...
      const feed = new RSS({
        ...
        copyright: `${
          pluginOptions.copyright ? pluginOptions.copyright : "Sarim Abbas 2019"
        }`,
        language: "en"
      });
      ...
      pages
        .filter(
          page =>
            String(page.frontmatter.type).toLowerCase() === "post" ||
            String(page.frontmatter.type).toLowerCase() === "project"
        )
